...
flowchart TD
    ...
    style C fill:#f0fdf4,stroke:#16a34a,color:#1e293b
    style D fill:#f0fdf4,stroke:#16a34a,color:#1e293b
    style E fill:#fff7ed,stroke:#ea580c,color:#1e293b
    style F fill:#fff7ed,stroke:#ea580c,color:#1e293b
```
...
flowchart LR
    ...
    style A fill:#eff6ff,stroke:#2563eb,color:#1e293b
    style G fill:#fee2e2,stroke:#dc2626,color:#1e293b
```
